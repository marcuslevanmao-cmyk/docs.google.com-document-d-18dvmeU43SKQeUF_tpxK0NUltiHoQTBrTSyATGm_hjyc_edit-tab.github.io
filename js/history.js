...
// ============================================================
// 2. FULL HISTORY — all Marcus's edits (8 versions)
// ============================================================
...
// ============================================================
// 3. localStorage persistence (so your history survives reloads)
// ============================================================
...
// ============================================================
// 4. HISTORY ENGINE (with snapshot, preview, rollback)
// ============================================================
...
function previewVersion(versionId) {
    ...
    if (canvas) {
        ...
        // For Marcus's versions, add a subtle left border to indicate his edits
...
// Helper to restore full document state (used by rollback)
...
function initHistory() {
    ...
    if (currentHistory.length > 0) {
        // Preview the latest version (index 0) and restore its state as current document
